...
const REGULATORY: ResearchSource[] = [
  {
    ...
    query: "refrigerant OR \"AIM Act\" OR hydrofluorocarbon",
    tier: "REGULATORY",
    category: "regulatory",
  ...
  },
  {
    ...
    kind: "federalregister",
    url: "https://www.federalregister.gov/api/v1/documents.json",
    query: "\"building energy code\" OR \"energy conservation standards\"",
    tier: "REGULATORY",
    category: "regulatory",
  ...
  },
  {
    ...
    kind: "federalregister",
    url: "https://www.federalregister.gov/api/v1/documents.json",
    query: "wetlands OR stormwater OR \"environmental impact statement\"",
    tier: "REGULATORY",
    category: "regulatory",
  ...
  },
  {
    ...
    kind: "federalregister",
    url: "https://www.federalregister.gov/api/v1/documents.json",
    query: "\"construction industry\" OR infrastructure grant OR bridge safety",
    tier: "REGULATORY",
    category: "regulatory",
  ...
  },
  {
    ...
    kind: "federalregister",
    url: "https://www.federalregister.gov/api/v1/documents.json",
    query: "\"transmission interconnection\" OR \"electric reliability\"",
    tier: "REGULATORY",
    category: "regulatory",
    trades: ["electrical"],
    metro: "national",
